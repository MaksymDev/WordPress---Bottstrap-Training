...
if ( ! function_exists( 'practice_setup' ) ) :
	...
	function practice_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'practice_custom_background_args', array(
...
function practice_scripts() {
	...
	wp_enqueue_script( 'practice-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
